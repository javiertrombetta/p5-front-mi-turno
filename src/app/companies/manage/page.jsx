...
const CreateBusiness = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setAlertInfo({ open: true, type: 'success', message: 'Empresa creada con éxito.' });
  ...
  return (
    <Container>
      <Typography variant="h4" sx={{ mb: 4 }}>Creación de Empresa</Typography>
      <Box component="form" onSubmit={handleSubmit} sx={{ mb: 4 }}>        
        ...
        <Button variant="contained" color="primary" type="submit" sx={{ px: 3, py: 1.5, fontSize: '1rem', mt: 4 }}>
          Crear Empresa
        </Button>
        <Alert
          open={alertInfo.open}

    ...
    <Box>
      <Box sx={{ mb: 10 }}>
        ...
        <Typography variant="body1" component="div">
          ...
          Hecho el {formatDate(reservation.createdAt)} para el día {formatDate(reservation.date)} a las {reservation.time} hs.
        </Typography>
      </Box>    
      <Grid container spacing={2}>
        ...
        <Grid item xs={12} sm={4}>
          ...
          <Typography variant="body1">Sucursal: {reservation.branchName || 'Nombre no disponible'}</Typography>
          <Typography variant="body1">Horario: {reservation.time}</Typography>
        </Grid>
